...
>将一个数组中的元素排序。
### 分析
a.选择一个元素作为基准值，存储起来</br>
b.依次分别使用左边元素和右边元素与基准值进行比较，将比基准值小的元素放在基准值的左边，将比基准之大的元素放到基准值的右边</br>
c.重复以上过程，直到两边的元素下标重合，将基准值放到重合的位置上，此时基准值左边的元素都比基准值小，基准值右边的元素都比基准值大</br>
d.采用递归的方法分别对基准值左边和右边的元素进行分组排序处理
### 复杂度
平均时间复杂度是 O(NlogN)，不稳定，对有序性不敏感，速度最快
### 参考链接
https://blog.csdn.net/MoreWindows/article/details/6684558
### 算法实现
[SortQuick.c](https://github.com/Ray1024/algorithms/blob/master/SortQuick.c)
